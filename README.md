...
> This should only occur if running locally. Check to ensure the credentials listed in `/src/main/resources/config.properties` matches the credentails assigned to your NLU service.
...
> If you have deployed your app on the IBM Cloud, check to ensure the MODEL_ID vcap variable in your runtime instance is set correctly, as described in the **Deploy to IBM Cloud** section of [Step #11](#11-run-the-application) above.
